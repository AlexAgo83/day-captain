...
class DayCaptainSettingsTest(unittest.TestCase):
    ...
    def test_validation_summary_reports_resolved_runtime(self) -> None:
        ...
        self.assertEqual(summary["configured_target_user_count"], 2)
        self.assertTrue(summary["selected_target_user_configured"])
        self.assertFalse(summary["dedicated_sender_configured"])
        self.assertEqual(summary["email_command_sender_route_count"], 0)
        self.assertNotIn("tenant_id", summary)
