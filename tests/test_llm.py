...
class OpenAICompatibleDigestWordingProviderTest(unittest.TestCase):
    def test_rewrite_summaries_posts_chat_completion_request(self) -> None:
        ...
        self.assertIn("older thread context", captured["body"]["messages"][0]["content"])
        self.assertIn("140 to 220 character range", captured["body"]["messages"][0]["content"])
        self.assertIn("raw business fragments", captured["body"]["messages"][0]["content"])
