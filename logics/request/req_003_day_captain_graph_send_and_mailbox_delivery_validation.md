...
# Backlog
- `item_003_day_captain_graph_send_and_mailbox_delivery_validation` - Add real delegated Outlook delivery and validate mailbox receipt.
- `task_006_day_captain_graph_send_delivery_execution` - Implement real Graph `sendMail` execution and config/auth guardrails. Status: `Ready`.
