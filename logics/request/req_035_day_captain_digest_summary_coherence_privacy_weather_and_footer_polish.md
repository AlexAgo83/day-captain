...
- a small Day Captain footer/copyright line in the mail rendering
...
- AC5: The weather line can indicate whether rain is expected when the configured forecast data supports that signal.
...
- AC7: The quick-actions area explains what the buttons do, and the digest includes a small Day Captain footer/copyright line.
- AC8: Tests and docs are updated to cover summary coherence, short-message handling, privacy-safe abstraction, rain copy, recurrence indication, and footer/quick-actions wording.
