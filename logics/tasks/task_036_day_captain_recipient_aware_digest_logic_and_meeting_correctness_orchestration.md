...
- [ ] 2. Add short assistant summaries for surfaced mail cards.
- [ ] 3. Improve French digest language coherence for English-source content.
- [ ] 4. Enforce chronological meeting ordering and highlight relevant overnight changes.
...
- Req031 AC2 -> Plan step 2. Proof: task explicitly adds per-mail summaries.
- Req031 AC3 -> Plan step 3. Proof: task explicitly includes bilingual wording coherence.
- Req031 AC4 -> Plan step 4. Proof: task explicitly includes meeting ordering correctness and change visibility.
- Req031 AC5 -> Plan steps 1 through 4. Proof: closure depends on aligned tests and docs across the whole slice.
...
- Request(s): `req_031_day_captain_recipient_aware_digest_identity_mail_summaries_language_coherence_and_meeting_chronology`
