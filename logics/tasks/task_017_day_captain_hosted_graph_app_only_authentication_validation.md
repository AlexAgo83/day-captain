...
- Validation executed:
  ...
  - `PYTHONPATH=src python3 -m day_captain validate-hosted-service --target-user alexandre.agostini@circle-mobility.com --timeout-seconds 120 --expect-graph-auth-mode app_only --expect-storage-backend postgres`
