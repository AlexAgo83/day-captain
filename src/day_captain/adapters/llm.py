            ...
            "messages": (
                {
                    ...
                    "content": (
                        ...
                        "Use older thread context from `context_metadata` by default when it helps ground the summary, instead of relying on the last reply alone. "
                        "Keep each summary concise but long enough to finish a complete thought; a typical summary will often stay in roughly the 140 to 220 character range depending on the item type. "
                        ...
                        "Do not echo raw business fragments more literally than needed when a safer abstraction is clearer. "
