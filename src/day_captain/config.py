...
class DayCaptainSettings:
    ...
    def validation_summary(self, target_user_id: str = "") -> Mapping[str, object]:
        ...
        return {
            ...
            "selected_target_user_configured": bool(resolved_target),
            "dedicated_sender_configured": bool(self.graph_sender_user_id.strip()),
            "email_command_sender_route_count": len(self.resolved_email_command_sender_routes()),
